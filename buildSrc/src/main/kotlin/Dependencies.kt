...
const val kotlinMultiplatformPlugin = "multiplatform"
const val composePlugin = "org.jetbrains.compose"

object Versions {
    const val android_app = "7.3.1"
    const val android_lib = "7.3.1"
    const val kotlin_multiplatform = "1.8.10"
...
object Depends {
    ...
    object Compose {
        ...
        const val compiler = "androidx.compose.compiler:compiler:${Versions.compose_compiler_version}"
